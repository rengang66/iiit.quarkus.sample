...
public class ProjectResource {
	...
	public List<Project> list() {
		LOGGER.info("ProjectResource类的list()生产的日志");
	...
	public Response get(@PathParam("id")  int id) {        	
        ...
        LOGGER.info("ProjectResource类的get()生产的日志");
	...
	public Response add(Project project) {		
		...
		service.add(project);
		LOGGER.info("ProjectResource类的add(Project project)生产的日志");
		return Response.ok(project).build();
	}
	...
	public Response update(Project project) {		
		...
		LOGGER.info("ProjectResource类的update(Project project)生产的日志");
		return Response.ok(project).build();
	}
	...
	public Response delete(Project project) {		
		...
		LOGGER.info("ProjectResource类的delete(Project project)生产的日志");
		return Response.ok(project).build();
	}
}